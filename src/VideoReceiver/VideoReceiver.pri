...
LinuxBuild {
    ...
    #- gstreamer assumed to be installed in $$PWD/../../gstreamer-1.0-android-universal-1.16.1/***
    contains(ANDROID_TARGET_ARCH, armeabi-v7a) {
        GST_ROOT = $$PWD/../../gstreamer-1.0-android-universal-1.16.1/armv7
    } else:contains(ANDROID_TARGET_ARCH, arm64-v8a) {
        GST_ROOT = $$PWD/../../gstreamer-1.0-android-universal-1.16.1/arm64
    } else:contains(ANDROID_TARGET_ARCH, x86_64) {
        GST_ROOT = $$PWD/../../gstreamer-1.0-android-universal-1.16.1/x86_64
    } else {
